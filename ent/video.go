...
func (*Video) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case video.FieldDuration, video.FieldViewCount, video.FieldLikeCount, video.FieldDislikeCount, video.FieldWidth, video.FieldHeight, video.FieldEpoch, video.FieldCommentCount, video.FieldThumbnailsWidth, video.FieldThumbnailsHeight:
