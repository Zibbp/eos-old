...
type Video struct {
	...
	// path to storyboard of thumbnails
	ThumbnailsPath string `json:"thumbnails_path,omitempty"`
	// width of storyboard of thumbnails
	ThumbnailsWidth int `json:"thumbnails_width,omitempty"`
	// height of storyboard of thumbnails
	ThumbnailsHeight int `json:"thumbnails_height,omitempty"`
	// interval of storyboard of thumbnails
	ThumbnailsInterval float64 `json:"thumbnails_interval,omitempty"`
	// rows of storyboard of thumbnails
	ThumbnailsRows int `json:"thumbnails_rows,omitempty"`
	// whether the storyboard of thumbnails is generated by eos
	EosGeneratedThumbnails bool `json:"eos_generated_thumbnails,omitempty"`
...
func (*Video) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case video.FieldFps, video.FieldAbr, video.FieldVbr, video.FieldThumbnailsInterval:
			values[i] = new(sql.NullFloat64)
		case video.FieldDuration, video.FieldViewCount, video.FieldLikeCount, video.FieldDislikeCount, video.FieldWidth, video.FieldHeight, video.FieldEpoch, video.FieldCommentCount, video.FieldThumbnailsWidth, video.FieldThumbnailsHeight, video.FieldThumbnailsRows:
			values[i] = new(sql.NullInt64)
		case video.FieldID, video.FieldTitle, video.FieldDescription, video.FieldUploader, video.FieldFormat, video.FieldResolution, video.FieldAudioCodec, video.FieldVideoCodec, video.FieldTags, video.FieldCategories, video.FieldVideoPath, video.FieldThumbnailPath, video.FieldJSONPath, video.FieldCaptionPath, video.FieldPath, video.FieldThumbnailsPath:
...
func (v *Video) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case video.FieldThumbnailsPath:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field thumbnails_path", values[i])
			} else if value.Valid {
				v.ThumbnailsPath = value.String
			}
		case video.FieldThumbnailsWidth:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field thumbnails_width", values[i])
			} else if value.Valid {
				v.ThumbnailsWidth = int(value.Int64)
			}
		case video.FieldThumbnailsHeight:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field thumbnails_height", values[i])
			} else if value.Valid {
				v.ThumbnailsHeight = int(value.Int64)
			}
		case video.FieldThumbnailsInterval:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field thumbnails_interval", values[i])
			} else if value.Valid {
				v.ThumbnailsInterval = value.Float64
			}
		case video.FieldThumbnailsRows:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field thumbnails_rows", values[i])
			} else if value.Valid {
				v.ThumbnailsRows = int(value.Int64)
			}
		case video.FieldEosGeneratedThumbnails:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field eos_generated_thumbnails", values[i])
			} else if value.Valid {
				v.EosGeneratedThumbnails = value.Bool
			}
...
func (v *Video) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("thumbnails_path=")
	builder.WriteString(v.ThumbnailsPath)
	builder.WriteString(", ")
	builder.WriteString("thumbnails_width=")
	builder.WriteString(fmt.Sprintf("%v", v.ThumbnailsWidth))
	builder.WriteString(", ")
	builder.WriteString("thumbnails_height=")
	builder.WriteString(fmt.Sprintf("%v", v.ThumbnailsHeight))
	builder.WriteString(", ")
	builder.WriteString("thumbnails_interval=")
	builder.WriteString(fmt.Sprintf("%v", v.ThumbnailsInterval))
	builder.WriteString(", ")
	builder.WriteString("thumbnails_rows=")
	builder.WriteString(fmt.Sprintf("%v", v.ThumbnailsRows))
	builder.WriteString(", ")
	builder.WriteString("eos_generated_thumbnails=")
	builder.WriteString(fmt.Sprintf("%v", v.EosGeneratedThumbnails))
	builder.WriteString(", ")
