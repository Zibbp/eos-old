...
func (cq *ChapterQuery) QueryVideo() *VideoQuery {
	query := (&VideoClient{config: cq.config}).Query()
...
func (cq *ChapterQuery) First(ctx context.Context) (*Chapter, error) {
	nodes, err := cq.Limit(1).All(newQueryContext(ctx, TypeChapter, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (cq *ChapterQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = cq.Limit(1).IDs(newQueryContext(ctx, TypeChapter, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (cq *ChapterQuery) Only(ctx context.Context) (*Chapter, error) {
	nodes, err := cq.Limit(2).All(newQueryContext(ctx, TypeChapter, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (cq *ChapterQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = cq.Limit(2).IDs(newQueryContext(ctx, TypeChapter, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (cq *ChapterQuery) All(ctx context.Context) ([]*Chapter, error) {
	ctx = newQueryContext(ctx, TypeChapter, "All")
	if err := cq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (cq *ChapterQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
	ctx = newQueryContext(ctx, TypeChapter, "IDs")
...
func (cq *ChapterQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypeChapter, "Count")
	if err := cq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (cq *ChapterQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypeChapter, "Exist")
...
func (cq *ChapterQuery) WithVideo(opts ...func(*VideoQuery)) *ChapterQuery {
	query := (&VideoClient{config: cq.config}).Query()
...
func (cq *ChapterQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Chapter, error) {
	...
	if query := cq.withVideo; query != nil {
		if err := cq.loadVideo(ctx, query, nodes, nil,
			func(n *Chapter, e *Video) { n.Edges.Video = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *ChapterQuery) loadVideo(ctx context.Context, query *VideoQuery, nodes []*Chapter, init func(*Chapter), assign func(*Chapter, *Video)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Chapter)
	for i := range nodes {
		if nodes[i].video_chapters == nil {
			continue
		}
		fk := *nodes[i].video_chapters
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "video_chapters" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (cgb *ChapterGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeChapter, "GroupBy")
...
func (cs *ChapterSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypeChapter, "Select")
